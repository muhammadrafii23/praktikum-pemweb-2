    ...
    <div class="card-body">
        <form action="?page=matakuliah-show" method="POST">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukkan Kode atau Nama..." name="keyword">
            ...
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                <tbody>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM matakuliah WHERE nim LIKE '%$keyword%' OR nama LIKE '%$keyword%' LIMIT $mulai, $limit");
                        }
                    } else {
